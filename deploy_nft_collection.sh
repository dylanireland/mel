...
--session-arg "json_schema:string='{\"properties\":{ \"mel_name\":{\"name\":\"mel_name\",\"description\":\"The name of the Mel.\",\"required\":true},\"coins\":{\"name\":\"coins\",\"description\":\"The amount of coins the user owns.\",\"required\":true},\"skins\":{\"name\":\"skins\",\"description\":\"A list of skins the user owns.\",\"required\":true},\"active_skin\":{\"name\":\"active_skin\",\"description\":\"The skin that the player has enabled.\",\"required\":true}}}'" \
